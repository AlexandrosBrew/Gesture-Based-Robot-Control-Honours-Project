...
from RobotControl.PID import PIDController # Import your new class
...
class baseControl:
    ...
    def update_base_position(self, hand_landmarks):
        """Update base rotation dynamically using PID."""
